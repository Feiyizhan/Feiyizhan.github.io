...
```java
package com.expertsplatform.enums.system.message;

import com.abc.commons.source.pojo.form.WxocTemplateMessageForm;
import com.abc.utils.inner.expertplatform.InnerProjectWxocApi;
